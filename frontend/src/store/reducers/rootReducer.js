...
export function reduce(state = initialState, action) {
    ...
    switch (action.type) {
        case GET_NODES:
            ...
            return { ...state, nodes: copyNodes, headNodes: [...copyNodes.keys()], error: false }
        case GET_NODE_CHILD:
            ...
            return { ...state, nodes: copyNodes, error: false }
        case CHANGE_HIDE:
        ...
        case CHANGE_NODE:
            ...
            return { ...state, nodes: copyNodes, error: false }
        case ERROR:
            return { ...state, error: true, errorInfo: action.payload }
        default:
            return state
    }
}
